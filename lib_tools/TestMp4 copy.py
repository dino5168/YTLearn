...
def convert_srt_to_ass(srt_path: str) -> Path:
    ...
    english_style.primarycolor = Color(255, 255, 255, 0)
    english_style.outlinecolor = Color(0, 0, 0, 0)
    english_style.backcolor = Color(0, 0, 139, 180)  # 深藍半透明
...
def embed_ass_with_overlay(mp4_path: str, ass_path: str, output_path: str) -> bool:
    ...
    if sys.platform == "win32":
        ...
        subtitle_input = subtitle_input.replace("\\", "/")

    # FFmpeg 濾鏡：drawbox + ass
