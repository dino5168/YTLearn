...
# === 1. 設定檔案路徑 ===
audio_file = r"c:\mp3\test\22984-02.mp3"
english_srt_file = r"c:\mp3\test\02.srt"  # 英文字幕檔案
chinese_srt_file = r"c:\mp3\test\02.zh-TW.srt"  # 中文字幕檔案
output_file = r"c:\mp3\test\T02.mp4"
